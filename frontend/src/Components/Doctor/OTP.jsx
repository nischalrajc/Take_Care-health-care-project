...
function OTP({ formData, mailOTP, forgetPasswordResendHandler, email }) {
    ...
    const forget_Password_ResendHandler = () => {
    ...
    const verifyHandler = () =>{
        if (otp === OTP) {
            navigate('/doctor/new_password',{state:{email:email}})
        } else {
        ...
        <div>
            <form onSubmit={submitHandler}>
                ...
                <div className=' p-4 mt-3'>
                    {
                        forgetPasswordResendHandler ? (
                            <button onClick={verifyHandler} className="text-white bg-[#2D6A76] rounded-md  px-6 sm:px-8 py-2 sm:py-2">
                                Verify
                            </button>
                        ) : (
...

                    {
                        forgetPasswordResendHandler ? (
                            <button
                                type="button"
                                onClick={forget_Password_ResendHandler}
